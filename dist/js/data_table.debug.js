...
(function($) {
  var DataTable, SimplyBind, _sim_21817, _sim_28ef4, currentID, defaults, escHTML, extend, helpers, markup;
  _sim_28ef4 = (function(exports){
  ...
  /* istanbul ignore next */
  if ((typeof module !== "undefined" && module !== null ? module.exports : void 0) != null) {
    return module.exports = DataTable;
  } else if (typeof define === 'function' && define.amd) {
    return define(['data_table'], function() {
      return DataTable;
    });
  } else {
