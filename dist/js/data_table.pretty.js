...
(function($) {
  var DataTable, _sim_2b897, currentID, defaults, extend, helpers, markup;
  _sim_2b897 = (function(exports){
  ...
  markup = {
    ...
    table: function(arg) {
      ...
      return "<div class='" + baseClass + " alignment---" + alignment + " sortDirection---{{sortDirection}}'> <div class='" + baseClass + "-heading'> <div class='" + baseClass + "-heading-row'> <div class='" + baseClass + "-heading-row-cell _expandButton'></div> </div> </div> <div class='" + baseClass + "-body'></div> </div>";
    },
    ...
    row: function(arg) {
      ...
      return "<div class='" + baseClass + "-body-row _tableRow {{drilldownOpen}}' data-row-id='" + rowID + "'> <div class='" + baseClass + "-body-row-cell _expandButton'> <div class='" + baseClass + "-body-row-cell-expand'></div> </div> " + cells + " <div class='" + baseClass + "-body-row-drilldown _tableRowDrilldown'> " + drilldown + " </div> </div>";
    },
    ...
    fieldsItem: function(arg) {
      var baseClass, label, value;
      baseClass = arg.baseClass, label = arg.label, value = arg.value;
      return "<div class='" + baseClass + "-fieldGroup-item'> <div class='" + baseClass + "-fieldGroup-item-label'>" + label + ": </div> <div class='" + baseClass + "-fieldGroup-item-value'>" + value + "</div> </div>";
    },
    button: function(arg) {
    ...
    actions: function(arg) {
      var baseClass, ctions;
      baseClass = arg.baseClass, ctions = arg.ctions;
      return "<div class='" + baseClass + "-actions'> <div class='" + baseClass + "-actions-popup'>" + actions + "</div> </div>";
    },
    actionsOverlay: function(arg) {
      var baseClass;
      baseClass = arg.baseClass;
      return "<div class='" + baseClass + "-actions-overlay'></div>";
    },
  ...
  DataTable.prototype.updateColumns = function(updatedColumns) {
    return updatedColumns = helpers.normalizeColumns(updatedColumns);
  };
  ...
  currentID = 0;
  DataTable.version = (function(_this) {
    return function() {};
  })(this)();
  '2.7.2';
