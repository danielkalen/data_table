...
(function($) {
  ...
  markup = {
    ...
    table: function(arg) {
      ...
      return "<div class='" + DataTable.defaults.baseClass + " alignment---" + alignment + "'> <div class='" + DataTable.defaults.baseClass + "-heading'> <div class='" + DataTable.defaults.baseClass + "-heading-row'> <div class='" + DataTable.defaults.baseClass + "-heading-row-cell _expandButton'></div> </div> </div> <div class='" + DataTable.defaults.baseClass + "-body'></div> </div>";
    },
    loading: function() {
