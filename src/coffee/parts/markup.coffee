...
export tableOuterwrap = ({ID, baseClass, minWidth, hasMobile, cellsHavePadding})-> "
...
export table = ({baseClass, alignment})-> "
...
export noResults = ({baseClass, itemSingleLabel='Item', itemPluralLabel=itemSingleLabel+'s'})-> "
...
export pageStatus = ({baseClass, showPageStatus})-> "
...
export paginationItem = ({baseClass, value})-> "
...
export headingCell = ({baseClass, extraClasses='', slug, icon='', label, style=''})-> "
...
export row = ({baseClass, rowID, cells, drilldown=''})-> "
...
export rowCell = ({baseClass, extraClasses='', label, column, slug, value, style=''})-> "
...
export searchField = ({baseClass, search})-> "
...
export ipDetails = ({baseClass, ipAddress, extra=''})-> "
...
export ipDetailsItem = ({baseClass, label, value})-> "
...
export fields = ({baseClass, fields})-> "
	<div class='#{baseClass}-fieldGroup'>#{fields}</div>
"

export fieldsItem = ({baseClass, label,value})-> "
...
export button = ({baseClass, action, icon='', isMulti})-> "
...
export actions = ({baseClass, actions})-> "
...
export actionsItem = ({baseClass, action, icon, label, customIconStyle=''})-> "
